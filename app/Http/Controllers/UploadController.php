...
use App\Models\{Store, UploadLog, Order, StoreMetric, AdsPerformance};
...
class UploadController extends Controller
{
    ...
    public function upload(Request $request)
    {
        ...
        return back()->with('success', "File \"$filename\" berhasil diupload dan diproses! ($log->rows_parsed baris data)");
    }
}
