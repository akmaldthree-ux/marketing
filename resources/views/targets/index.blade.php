      ...
      <table class="table table-sm table-hover mb-0" style="font-size:.8rem;">
        <thead class="table-light">
          <tr>
            ...
            <th>Brand</th>
            @foreach($months as $i=>$m)<th class="text-end">{{ $m }}</th>@endforeach
          </tr>
        </thead>
        <tbody>
        ...
        <tr>
          ...
          <td class="text-end">
            @if($t)
              <span class="text-nowrap">{{ number_format($t->gmv_target/1000000,1) }}jt</span>
            @else
...
<div class="modal fade" id="addModal">
  <div class="modal-dialog"><div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="mb-2"><label class="form-label small">Target GMV (Rp)</label><input type="number" name="gmv_target" class="form-control form-control-sm" min="0" step="1000000" required></div>
    </div>
